...
describe('Blog e2e test', () => {
  ...
  const blogSample = { name: 'ouch bonfire cute', handle: 'slowly' };
  ...
  describe('new Blog page', () => {
    ...
    it('should create an instance of Blog', () => {
      cy.get(`[data-cy="name"]`).type('unto');
      cy.get(`[data-cy="name"]`).should('have.value', 'unto');

      cy.get(`[data-cy="handle"]`).type('furthermore reassuringly volunteer');
      cy.get(`[data-cy="handle"]`).should('have.value', 'furthermore reassuringly volunteer');
